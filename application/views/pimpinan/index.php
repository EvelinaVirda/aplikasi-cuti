        ...
        <table class="table table-hover table-striped">
						...
						<tbody>
							<tr>
				                ...
				                ?>
				                <td>
				                <a class="btn btn-primary" href="<?php echo site_url('pimpinan/detail_cuti/'.$u->id_karyawan);?>"> Detail</a>
				                <a class="btn btn-success" href="<?php echo site_url('pimpinan/edit_status_cuti/'.$u->id_cuti);?>"> Edit Status</a>
