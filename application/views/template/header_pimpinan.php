    ...
    <div class="header">
      ...
      <div class="col-md-2">
        <div class="sidebar content-box" style="display: block;">
                <ul class="nav">
                    <!-- Main menu -->
                    <li><a href="<?php echo base_url('pimpinan/data_karyawan') ?>"><i class="glyphicon glyphicon-thumbs-up"></i>Data Karyawan</a></li>
                    <li><a href="<?php echo base_url('pimpinan') ?>"><i class="glyphicon glyphicon-thumbs-up"></i> Pengajuan Cuti</a></li>
             </div>
      </div>
